...
def weight_variable(shape):
    ...
    """
        When training models - we use variables to establish mutable initialize mutable
        objects that we can both read and write to. Variables are modelled as computational
        graphs - making the task of backpropogation a simpler one. We provide the information
        that'll be used to generate the computation tree and the session does that.
    """
...
"""
    / Generate system of linear equations where for a given tensor - number
    of rows correspond to the number of neurons. 
"""
...
def conv2d(x, W):
    """
        Computes a 2 dimensional convulutions over a 4 dimensional input
    """
...
"""
"""
    Use 'none' should dimension be unknown until run time
"""
...
# layer 1
"""
    Batch of 5 kernels - each (5 x 1 x 16)
"""
